...
description: >
  ...
  即使用户没有明确说出上述关键词，只要意图涉及需求文档的质量改进、信息补全或测试覆盖，都应触发此 Skill。
---
...
| `output/prd-updated.md` | 是 | 已有补全后文档，req-testcase 优先使用此版本 |
...
- `shared/prd-template.md`：补全后文档的输出模板
- `shared/testcase-template.md`：测试用例的输出模板
